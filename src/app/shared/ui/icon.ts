...
/**
 * Inline SVG icons (Lucide geometry), kept as static markup so there is no
 * icon-font or sprite request. Strokes use `currentColor`, so an icon takes
...
const ICONS: Record<string, string> = {
  ...
  map: '<path d="M9 6.5V3"/><path d="M15 21v-3.5"/><path d="M9 21v-4"/><path d="M15 10.5V7"/><circle cx="9" cy="9.5" r="2.5"/><circle cx="15" cy="14" r="2.5"/>',
  heart:
...
export class Icon {
  ...
  protected readonly markup = computed<SafeHtml>(() =>
    // Static, compile-time constants — never user input.
